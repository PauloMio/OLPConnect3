...
if (isset($_POST['add_department'])) {
    ...
    if (!empty($department)) {
        $stmt = $conn->prepare("INSERT INTO tbl_department (department, created_at, updated_at) VALUES (?, NOW(), NOW())");
...
// ===== READ =====
$departments = $conn->query("SELECT * FROM tbl_department ORDER BY created_at DESC");
?>
